...
def main():
    ...
    embeddings = []
    for i in tqdm(range(0, len(urls), batch_size), desc="Building sample_10k embeddings"):
    ...
    np.save(output_dir / "sample_10k_embeddings.npy", embeddings)
    np.save(output_dir / "sample_10k_features.npy", handcrafted)
    np.save(output_dir / "sample_10k_labels.npy", labels)
    ...
    print("Saved sample_10k artifacts")

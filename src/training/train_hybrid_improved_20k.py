...
def main():
    ...
    # Load raw components
    embeddings = np.load("data/sample/sample_20k_embeddings.npy")
    features = np.load("data/sample/sample_20k_features.npy")
    labels = np.load("data/sample/sample_20k_labels.npy")
    ...
    torch.save(model.state_dict(), output_dir / "mlp_hybrid_20k_improved.pt")
    joblib.dump(scaler, output_dir / "hybrid_scaler_20k.pkl")

    with open(output_dir / "label_map.json", "w", encoding="utf-8") as f:
        json.dump(LABEL_MAP, f, ensure_ascii=False, indent=2)

    print("\nSaved model to models/saved/mlp_hybrid_20k_improved.pt")
    print("Saved scaler to models/saved/hybrid_scaler_20k.pkl")
